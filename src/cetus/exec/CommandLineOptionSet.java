...
public class CommandLineOptionSet {
    ...
    */
    public void add(int type,
        ...
        Driver.autoTurnedOnOptions.add("-"+name+"="+value);
        PrintTools.printlnStatus("[CommandLineOptionSet] option "+name+" is initialized with value = "+value,1); //
    }
    ...
    */
    public void add(int type, String name,
        ...
        if (value==null)
        	PrintTools.printlnStatus("[CommandLineOptionSet] option "+name+": if turned on without value, it will be assigned a value of: "+value_on,1);
        else {
            Driver.autoTurnedOnOptions.add("-"+name+"="+value);
        	PrintTools.printlnStatus("[CommandLineOptionSet] option "+name+" is initialized with value = "+value+"; if turned on without value, it will be assigned a value of: "+value_on,1);
        }
    }
    ...
    */
    public void setValue(String name, String value) {
        ...
        if (record != null) {
            record.value = value;
            PrintTools.printlnStatus("[CommandLineOptionSet] set option "+name+" to value: "+record.value+" (a new value)",0);
        }
    }
    ...
    public void setValue(String name) {
        ...
        if (record != null) {
            if (record.value_on == null) {
                record.value = "1";
                PrintTools.printlnStatus("[CommandLineOptionSet] set option "+name+" to value: "+record.value+" (general default)",0);
            } else {
                record.value = record.value_on;
                PrintTools.printlnStatus("[CommandLineOptionSet] set option "+name+" to value: "+record.value+" (predefined default)",0);
            }
        }
    }
