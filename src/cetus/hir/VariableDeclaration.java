...
public class VariableDeclaration extends Declaration {
    ...
    * declaration. Basically, it is equivalent to using getChildren() but
    * asserts the returned list contains symbol type.
    * @return the list of declared symbols.
    */
    public List<Symbol> getDeclaredSymbols() {
        List<Symbol> ret = new ArrayList<Symbol>(children.size());
