...
public class IPANode extends DFANode {
    ...
    */
    public IPANode(Procedure proc) {
        ...
        exception = 0;
        num_visits = 0;
        if (procedure.getParameters() != null && procedure.getParameters().toString().contains("...")) {
    ...
    */
    ...
    public String toString() {
        ...
        str.append("    IN =\n");
        if (isRoot()) {
            str.append("        ").append(PrintTools.collectionToString((Set)this.in(), ", ")).append("\n");
        } else {
            for (Set<CallSite> calling_sites : in.keySet()) {
        ...
        str.append("    OUT =\n").append("        ").append(PrintTools.collectionToString((Set)this.out(), ", ")).append("\n");
        str.append("    Calls =\n");
        for (CallSite site : getCallSites()) {
            str.append("        ").append(site).append("\n");
            str.append("            IN = ").append(PrintTools.collectionToString((Set)site.in(), ", ")).append("\n");
            str.append("            OUT = ").append(PrintTools.collectionToString((Set)site.out(), ", ")).append("\n");
        }
        return str.toString();
    }
}
