...
public class CetusGUITools {
	...
	public static final String guideMessage = "You can directly edit your C file in the text area. " +
			...
			"Click [Output] to translate input sequential C code into parallel OpenMP code. " +
			"Click [Speedup] to compile and run serial and OpenMP code, calculate speedup and efficiency, and display graphs. " +
	...
	public static boolean writeStringToFileAddNewLine(File file, String fileText) {
		try {
			int indexLastLine = fileText.lastIndexOf("\n");
			String lastLine = fileText.substring(indexLastLine);
			//System.out.println(lastLine);
			if (lastLine.equals("\n")) {
				System.out.println("The last line is a new line, no additional new line needed.");
			} else {
